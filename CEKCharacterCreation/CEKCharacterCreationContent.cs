...
namespace CalradiaExpandedKingdoms.CEKCharacterCreation
{
  internal class CEKCharacterCreationContent : SandboxCharacterCreationContent
  {
    ...
    protected new bool VlandianParentsOnCondition() => CEKHelpers.IsInCultureGroup(this.GetSelectedCulture().StringId, "vlandia");

    protected new bool SturgianParentsOnCondition() => CEKHelpers.IsInCultureGroup(this.GetSelectedCulture().StringId, "sturgia");

    protected new bool EmpireParentsOnCondition() => CEKHelpers.IsInCultureGroup(this.GetSelectedCulture().StringId, "empire");

    protected new bool AseraiParentsOnCondition() => CEKHelpers.IsInCultureGroup(this.GetSelectedCulture().StringId, "aserai");

    protected new bool BattanianParentsOnCondition() => CEKHelpers.IsInCultureGroup(this.GetSelectedCulture().StringId, "battania");

    protected new bool KhuzaitParentsOnCondition() => CEKHelpers.IsInCultureGroup(this.GetSelectedCulture().StringId, "khuzait");
  }
}
