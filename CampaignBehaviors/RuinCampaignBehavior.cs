...
namespace CalradiaExpandedKingdoms.Ruins
{
  public class RuinCampaignBehavior : CampaignBehaviorBase
  {
    ...
    private void game_menu_ambush_continue_on_consequence(MenuCallbackArgs args) => this.StartAttack();
    ...
    private static void game_menu_ruin_ui_ambush_on_init(MenuCallbackArgs args) => args.MenuContext.SetBackgroundMeshName("wait_ambush");
  }
}
