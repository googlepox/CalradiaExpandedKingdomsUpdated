...
namespace CalradiaExpandedKingdoms.Docks
{
    public class DocksCampaignBehavior : CampaignBehaviorBase
    {
        ...
        {
            CampaignEvents.OnSessionLaunchedEvent.AddNonSerializedListener((object)this, new Action<CampaignGameStarter>(this.AddPortMenu));
        }
        ...
        public static bool visit_the_tavern_on_condition(MenuCallbackArgs args)
        {
            return (bool)DocksCampaignBehavior.visit_the_tavern_on_conditionMethodInfo.Invoke((object)null, new object[1]
        {
      (object) args
        });
        }
        ...
        {
            DocksCampaignBehavior.town_backstreet_on_initMethodInfo.Invoke((object)null, new object[1]
        {
      (object) args
        });
        }

        public static bool back_on_condition(MenuCallbackArgs args)
        {
            return (bool)DocksCampaignBehavior.back_on_conditionMethodInfo.Invoke((object)null, new object[1]
        {
      (object) args
        });
        }

        public static bool game_menu_town_town_leave_on_condition(MenuCallbackArgs args)
        {
            return (bool)DocksCampaignBehavior.game_menu_town_town_leave_on_conditionMethodInfo.Invoke((object)null, new object[1]
        {
      (object) args
        });
        }

        private bool IsAtSea()
        {
            return DocksCampaignBehavior.Towns.Contains(Settlement.CurrentSettlement);
        }
        ...
        private float CalculateTime(Settlement targetSettlement)
        {
            return Settlement.CurrentSettlement.GatePosition.Distance(targetSettlement.GatePosition) / 75f;
        }
