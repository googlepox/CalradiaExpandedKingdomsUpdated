...
namespace CalradiaExpandedKingdoms.Ariorum
{
    public class AriorumCampaignBehavior : CampaignBehaviorBase
    {
        ...
        private void game_menu_town_boa_start_quest_on_consequence(MenuCallbackArgs args)
        {
            new FindItemInRuinQuestBehavior.FindItemInRuinQuest("find_item_in_ruin", (Hero)null, CampaignTime.Never, 2000).StartQuest();
        }

        private bool game_menu_town_boa_start_quest_on_condition(MenuCallbackArgs args)
        {
            return true;
        }
        ...
        private void game_menu_town_boa_on_consequence(MenuCallbackArgs args)
        {
            GameMenu.SwitchToMenu("town_boa");
        }
        ...
        private void game_menu_town_boa_back_on_consequence(MenuCallbackArgs args)
        {
        ...
        public bool conversation_lord_is_threated_neutral_on_condition_new()
        {
        ...
        private bool caravan_loot_on_condition_new()
        {
            return MobileParty.ConversationParty.MapFaction != CEKHelpers.GetKingdomByID("ariorum") && MobileParty.ConversationParty != null && MobileParty.ConversationParty.IsCaravan && MobileParty.ConversationParty.Party.MapFaction != Hero.MainHero.MapFaction && MobileParty.ConversationParty.Party.Owner != Hero.MainHero;
        }
