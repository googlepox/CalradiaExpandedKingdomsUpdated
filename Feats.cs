...
namespace CalradiaExpandedKingdoms.Feats
{
    ...
    {
        public static FeatObject NordlingPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject NordlingPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject NordlingPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject NordlingPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject NordlingNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject NordlingNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject VagirPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject VagirPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject VagirPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject VagirPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject VagirNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject VagirNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject RhodokPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject RhodokPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject RhodokPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject RhodokPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject RhodokNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject RhodokNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject ApolssalianPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject ApolssalianPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject ApolssalianPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject ApolssalianPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject ApolssalianNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject ApolssalianNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject LyrionPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject LyrionPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject LyrionPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject LyrionPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject LyrionNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject LyrionNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject KhergitPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject KhergitPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject KhergitPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject KhergitPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject KhergitNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject KhergitNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject PaleicianPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject PaleicianPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject PaleicianPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject PaleicianPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject PaleicianNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject PaleicianNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject RepublicPositiveFeatOne
        {
            get; private set;
        }

        public static FeatObject RepublicPositiveFeatTwo
        {
            get; private set;
        }

        public static FeatObject RepublicPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject RepublicPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject RepublicNegativeFeatOne
        {
            get; private set;
        }

        public static FeatObject RepublicNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject EmpirePositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject EmpirePositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject EmpireNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject AseraiPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject AseraiPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject AseraiNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject BattaniaPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject BattaniaPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject BattaniaNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject KhuzaitPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject KhuzaitPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject KhuzaitNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject SturgiaPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject SturgiaPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject SturgiaNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject VlandianPositiveFeatThree
        {
            get; private set;
        }

        public static FeatObject VlandianPositiveFeatFour
        {
            get; private set;
        }

        public static FeatObject VlandianNegativeFeatTwo
        {
            get; private set;
        }

        public static FeatObject AriorumPositiveOne
        {
            get; private set;
        }

        public static FeatObject AriorumPositiveTwo
        {
            get; private set;
        }

        public static FeatObject AriorumPositiveThree
        {
            get; private set;
        }

        public static FeatObject AriorumPositiveFour
        {
            get; private set;
        }

        public static FeatObject AriorumNegativeOne
        {
            get; private set;
        }

        public static FeatObject AriorumNegativeTwo
        {
            get; private set;
        }
