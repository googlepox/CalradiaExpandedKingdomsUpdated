...
namespace CalradiaExpandedKingdoms.Quests.FindItemInRuin
{
    public class FindItemInRuinQuestBehavior : CampaignBehaviorBase
    {
        ...
        private void conversation_talk_to_old_man_accept_quest_on_consequence()
        {
        ...
        private void conversation_talk_to_old_man_deny_quest_on_consequence()
        {
            this.hasTalkedToOldMan = true;
        }

        private bool conversation_talk_to_old_man_on_condition()
        {
            return Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.StringId == "cek_quest_old_man";
        }
        ...
        public class FindItemInRuinQuest : QuestBase
        {
            ...
            {
                this.journal = this.AddLog(new TextObject("I will have to search some of these ruins to find the sword"));
            }
